...
if __name__ == '__main__':
    ...
    parser.add_argument('--backbone', type=str, default='convnext_tiny', help='Backbone model to use')
    parser.add_argument("--model_name", type=str, default="ConvNeXt", help="Name of the model to train")
